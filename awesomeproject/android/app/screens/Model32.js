...
class Model32 extends Component {
    ...
    return (
        ...
        <View style={styles.backgr}>
            ...
            <View style={{top:20}}>
                ...
                <View style={{height:17,width:17,backgroundColor:'green',right:-285,top:-35,borderRadius:40}}>
                </View>
            </View>
            ...
            <View style={styles.chenar}>
                <Image  
                style={{width:200,height:400,position:'absolute',left:173,top:-25}}
            ...
            <ProgressCircle
                ...
                bgColor="#696969"// culoare cerc mic inauntru
            >
            <Text style={styles.finished}>{random2+ '% finished'}</Text>
            </ProgressCircle>
            </View>
            ...
            <View style={styles.butonof}>
                <TouchableOpacity onPress={() => this.props.navigation.goBack()}>
                    <Image  style={{width:70,height:70,left:240,top:-5}} source={require('../assets/off.png')} />
                </TouchableOpacity>
