    ...
    return (
        ...
        <View style={styles.backgr}>
            ...
            <View style={styles.textdot}>
                ...
                <View style={{height:17,width:17,backgroundColor:'red',right:-285,top:-22,borderRadius:40}}>
                </View>
            </View>
            
            <View style={styles.chenar}>
                <Image  
                style={{width:250,height:300,alignSelf:'center',top:-70,left:10}}
                source={require('../assets/Ms.png')} />
                
                <TouchableOpacity onPress={() => navigation.navigate('modelS2')}>
                    <Image
